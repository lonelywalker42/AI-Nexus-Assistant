...
| **素材库** | 即将推出 |
| **游戏机** | 8款复古像素游戏(2048/Tetris/射击/单词/贪吃蛇/打砖块/扫雷/Flappy)、CRT效果、存档、排行榜、全屏 |
...
- **游戏机模式**: 8 款复古像素游戏 — 2048 / Tetris / 射击 / Word Hopper / 贪吃蛇 / 打砖块 / 扫雷 / Flappy Bird（CRT扫描线效果、进度存档、历史最高分排行榜、全屏支持）
