...
[![Tauri 2](https://img.shields.io/badge/Tauri_2-v3.2.0-orange.svg)](https://tauri.app/)
...
| 版本 | 技术栈 | 包体积 | 状态 |
|------|--------|--------|------|
| **Tauri 2 版** | Rust + React 19 + TypeScript + Tailwind CSS v4 + FastAPI | **~71MB 单文件** | ✅ v3.1.0 |
...
| **IDEA** | 知识卡片CRUD、随手记(快速记录想法)、AI对话关联、标签系统、JSON/MD/PDF导入、网页链接导入 |
| **试验管理** | 版本化结果记录、参数对比表、AI分析、Markdown导出 |
| **AI 对话** | 流式输出、工具调用(联网搜索)、thinking折叠、分类管理(通用/文献综述/IDEA/研究/选题讨论)、自动生成≤10字标题、@引用文献、研究讨论模板 |
...
- **游戏机模式**: 2048 / Tetris / 射击游戏(复古像素风格、CRT扫描线)
